...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div ref={contentRef} className="relative z-10 w-full pt-24 pb-10 will-change-transform">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="flex flex-col">
              <span className="overflow-hidden mb-1 block">
                <span ref={line1Ref} className="opacity-0 block text-[clamp(3rem,8vw,6.5rem)] font-black text-white leading-[0.95] tracking-tighter drop-shadow-lg">
                  El cuidado que
                </span>
              </span>
              ...
              <span className="overflow-hidden mb-8 block">
                <span ref={line3Ref} className="opacity-0 block text-[clamp(3rem,8vw,6.5rem)] font-black text-orange-400 leading-[0.95] tracking-tighter drop-shadow-lg">
                  merece.
                </span>
              </span>
            </h1>
      ...
      <div
        ref={scrollRef}
        className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 text-white/40 opacity-0 will-change-transform"
      >
