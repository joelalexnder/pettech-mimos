...
const socials = [
  ...
  { id: "fb", path: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" },
  { id: "tk", path: "M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" }
];
...
export default function Navbar() {
  ...
  return (
    ...
    >
      {/* max-w-[1440px] amplía el navbar para que no esté tan centrado */}
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-4 flex flex-col gap-1">
            ...
            <div className="mt-3 pt-4 border-t border-slate-100">
              <div className="flex justify-center gap-4 mb-4">
                {socials.map((s) => (
                  <a key={s.id} href="#" className="p-3 rounded-xl bg-slate-50 text-slate-400 hover:text-sky-500 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d={s.path} /></svg>
                  </a>
                ))}
              </div>
              <a
                href="https://wa.me/51910918802?text=Hola!"
                target="_blank"
                rel="noopener noreferrer"
